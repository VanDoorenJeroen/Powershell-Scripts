...
$MAILBE = @("DL_BE04_Desso_IT@tarkett.com", "Nicolas.VanDenBossche@tarkett.com", "Gunter.Geysen@Tarkett.com", "Victor.Verriere@Tarkett.com")
...
Checks if:
1. Devices are online -> Offline
2. If it's possible to make conneciton with PC -> Unreachable
3. Checks if the pc has an ini file -> No ini file
4. Checks if the ini file isn't overwritten -> Ini file overwritten
5. If CTWIN is running -> Ctwin not running
